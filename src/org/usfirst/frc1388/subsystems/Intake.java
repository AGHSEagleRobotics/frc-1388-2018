...
public class Intake extends Subsystem {
	...
	public final CANSD540 leftMotor = RobotMap.leftIntakeMotor; // references to motors in RobotMap, setting these will set RobotMap motors
	public final CANSD540 rightMotor = RobotMap.rightIntakeMotor;
